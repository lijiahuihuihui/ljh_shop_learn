 ...
 * Generated at: 2018-03-07 15:12:36 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<ul class=\"am-icon-flag on\">添加菜单\r\n");
      out.write("\t\t\t\t\t</ul>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/manage/menu/save\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"am-form-group am-cf\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"zuo\">菜单名称：</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"you\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"menu_name\" value=\"");
      ...
      out.write("\" class=\"am-input-sm\" id=\"doc-ipt-email-1\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"am-btn am-btn-success am-radius\">保存</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
