...
public class RoleManagerController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	List<RoleDomain> roleList = RoleService.selectByPage(pageNow*pageSize, pageSize) ;
    	request.setAttribute("roleList", roleList); 	
    	
    	request.getRequestDispatcher("/manage/role_manager.jsp").forward(request, response); 
    }
}
