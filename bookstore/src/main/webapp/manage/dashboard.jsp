	...
	<div class="am-cf admin-main">
		...
		<div class="nav-navicon admin-main admin-sidebar">
			...
			<div class="sideMenu">
				...
				<ul>
					<li><a href="/login-shoplist">商品列表</a></li>
					<li class="func" dataType='html' dataLink='msn.htm'
						iconImg='images/msn.gif'><a href="/login-addshop">添加新商品</a></li>
					<li><a href="/login-shopclassify">商品分类</a></li>
					<li><a href="/login-comment">用户评论</a></li>
					<li>商品回收站</li>
					<li><a href="/login-repertory">库存管理 </a></li>
				</ul>
				<h3 class="am-icon-cart-plus">
					<em></em> <a href="#"> 订单管理</a>
				</h3>
				<ul>
					<li><a href="/login-orderlist">订单列表</a></li>
					<li>合并订单</li>
					<li>订单打印</li>
					<li>添加订单</li>
					<li>发货单列表</li>
				...
				<ul>
					<li><a href="/login-userlist">会员列表</a></li>
					<li>未激活会员</li>
					<li>团队系谱图</li>
					<li>会员推荐图</li>
					<li>推荐列表</li>
				...
				<h3 class="am-icon-volume-up">
					<em></em> <a href="/login-message">信息通知</a>
				</h3>
				<ul>
					<li>站内消息 /留言</li>
					<li>短信</li>
				...
				<h3 class="am-icon-gears">
					<em></em> <a href="/login-system">系统设置</a>
				</h3>
				<ul>
					<li>数据备份</li>
					<li>邮件/短信管理</li>
